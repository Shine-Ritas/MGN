...
import { RecentlyUploadedMogou, SubMogousType } from './types'
        ...
        <div key={mogou.title} className="bg-slate-800/50 rounded-lg flex border border-slate-700 md:min-h-52 ">
            <div className='flex h-full w-full' >
                <Link
                    ...
                    to={`/show/${mogou?.slug}`} className="relative w-5/12  lg:w-5/12">
                                ...
                                return (
                                    <div className="relative overflow-hidden min-w-full  " key={index}>
                                        ...
                                        <Button
                                            ...
                                            size={'sm'}
                                            className={`flex gap-2 justify-start items-center ${sub_mogou.subscription_only && !userCanReadAll ? "bg-primary-muted" : ""}  w-full xl:me-4 text-xxs`}>
                                            {
